...
> CreateUser(ctx).ICreateUserRequestDTO(iCreateUserRequestDTO).Execute()
...
func main() {
	...
	r, err := apiClient.UserAPI.CreateUser(context.Background()).ICreateUserRequestDTO(iCreateUserRequestDTO).Execute()
	if err != nil {
...
> UpdateUsernameByID(ctx, id).IUpdateUsernameRequestDTO(iUpdateUsernameRequestDTO).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.UserAPI.UpdateUsernameByID(context.Background(), id).IUpdateUsernameRequestDTO(iUpdateUsernameRequestDTO).Execute()
	if err != nil {
