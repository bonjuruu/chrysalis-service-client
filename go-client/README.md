...
```go
import openapi "github.com/bonjuruu/chrysalis-service-client/go-client"
```
...
*UserAPI* | [**GetUserByEmail**](docs/UserAPI.md#getuserbyemail) | **Get** /chrysalis/user/email/{email} | 
*UserAPI* | [**UpdateUsernameByID**](docs/UserAPI.md#updateusernamebyid) | **Patch** /chrysalis/user/{id}/username | 


## Documentation For Models

 - [ICreatePostRequestDTO](docs/ICreatePostRequestDTO.md)
 - [ICreateUserRequestDTO](docs/ICreateUserRequestDTO.md)
 - [IPostDTO](docs/IPostDTO.md)
 - [IUpdatePostRequestDTO](docs/IUpdatePostRequestDTO.md)
 - [IUpdateUsernameRequestDTO](docs/IUpdateUsernameRequestDTO.md)
 - [IUserDTO](docs/IUserDTO.md)
 - [IUserRoleEnum](docs/IUserRoleEnum.md)
